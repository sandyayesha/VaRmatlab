function varargout = Norm_VaR(varargin)
% NORM_VAR MATLAB code for Norm_VaR.fig
%      NORM_VAR, by itself, creates a new NORM_VAR or raises the existing
%      singleton*.
%
%      H = NORM_VAR returns the handle to a new NORM_VAR or the handle to
%      the existing singleton*.
%
%      NORM_VAR('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in NORM_VAR.M with the given input arguments.
%
%      NORM_VAR('Property','Value',...) creates a new NORM_VAR or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before Norm_VaR_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to Norm_VaR_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help Norm_VaR

% Last Modified by GUIDE v2.5 09-Oct-2022 11:55:18

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @Norm_VaR_OpeningFcn, ...
                   'gui_OutputFcn',  @Norm_VaR_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before Norm_VaR is made visible.
function Norm_VaR_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to Norm_VaR (see VARARGIN)

% Choose default command line output for Norm_VaR
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes Norm_VaR wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = Norm_VaR_OutputFcn(hObject, eventdata, handles) 
...
function edit_masukkan_file_Callback(hObject, eventdata, handles)
% hObject    handle to edit_masukkan_file (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of edit_masukkan_file as text
%        str2double(get(hObject,'String')) returns contents of edit_masukkan_file as a double


% --- Executes during object creation, after setting all properties.
function edit_masukkan_file_CreateFcn(hObject, eventdata, handles)
% hObject    handle to edit_masukkan_file (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
...
sd=std(return_saham);
z=-norminv(1-alfa);
norm_VaR=-z*sqrt(hp)*sd*100;
S0=norm_VaR*S0/100;
set(handles.edit_VaR,'string',norm_VaR);
...
% --- Executes during object creation, after setting all properties.
function text_masukkan_file_CreateFcn(hObject, eventdata, handles)
% hObject    handle to text_masukkan_file (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
