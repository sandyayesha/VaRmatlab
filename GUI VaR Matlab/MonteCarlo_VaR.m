function varargout = MonteCarlo_VaR(varargin)
% MONTECARLO_VAR MATLAB code for MonteCarlo_VaR.fig
%      MONTECARLO_VAR, by itself, creates a new MONTECARLO_VAR or raises the existing
%      singleton*.
%
%      H = MONTECARLO_VAR returns the handle to a new MONTECARLO_VAR or the handle to
%      the existing singleton*.
%
%      MONTECARLO_VAR('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in MONTECARLO_VAR.M with the given input arguments.
%
%      MONTECARLO_VAR('Property','Value',...) creates a new MONTECARLO_VAR or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before MonteCarlo_VaR_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to MonteCarlo_VaR_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help MonteCarlo_VaR

% Last Modified by GUIDE v2.5 09-Oct-2022 12:05:17

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @MonteCarlo_VaR_OpeningFcn, ...
                   'gui_OutputFcn',  @MonteCarlo_VaR_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before MonteCarlo_VaR is made visible.
function MonteCarlo_VaR_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to MonteCarlo_VaR (see VARARGIN)

% Choose default command line output for MonteCarlo_VaR
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes MonteCarlo_VaR wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = MonteCarlo_VaR_OutputFcn(hObject, eventdata, handles) 
...
% --- Executes on button press in pushbutton_alfa.
function pushbutton_alfa_Callback(hObject, eventdata, handles)
% hObject    handle to pushbutton_alfa (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
...
% --- Executes on button press in pushbutton_pengulangan.
function pushbutton_pengulangan_Callback(hObject, eventdata, handles)
% hObject    handle to pushbutton_pengulangan (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)


% --- Executes on button press in pushbutton_inves_awal.
function pushbutton_inves_awal_Callback(hObject, eventdata, handles)
% hObject    handle to pushbutton_inves_awal (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
...
B=str2num(get(handles.edit_pengulangan,'String'));
...
VaR=[];
for i=1:ulangan
    Bangkitan=normrnd(mean(return_saham),std(return_saham),length(return_saham));
    Bangkitan_sort=sort(Bangkitan);
    persentil_alfa=ceil(alfa*length(Bangkitan_sort));
    VaRMC=-sqrt(hp)*Bangkitan_sort(persentil_alfa)*100;
    VaR=[VaR,VaRMC];
end
Var_MC=mean(VaR);
S0=Var_MC*S0/100;
set(handles.edit_VaR,'string',Var_MC);
...
set(handles.edit_pengulangan,'string','');
...
function edit_pengulangan_Callback(hObject, eventdata, handles)
% hObject    handle to edit_pengulangan (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of edit_pengulangan as text
%        str2double(get(hObject,'String')) returns contents of edit_pengulangan as a double


% --- Executes during object creation, after setting all properties.
function edit_pengulangan_CreateFcn(hObject, eventdata, handles)
% hObject    handle to edit_pengulangan (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
